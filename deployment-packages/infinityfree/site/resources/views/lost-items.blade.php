<?php
    $records = $lostItems ?? $items ?? collect();
...
<style>
    ...
    <title>Lost Items | IBBU Lost and Found System</title>
...
<div class="page">
    ...
    <div class="top-area">
        ...
        <div class="actions">
            <?php if(!$isAdmin): ?>
                <a href="/report-lost-item" class="primary-btn">Report Lost Item</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="page-heading">
        ...
        <p>View lost items reported by students and staff.</p>
    </div>
    ...
    <div class="items-grid">
                ...
                <div class="item-card">
                    ...
                    <div class="item-image">
                        <?php if(!empty($item->image)): ?>
                            <img src="<?php echo asset('storage/' . $item->image); ?>" alt="Lost Item Image">
                        <?php else: ?>
                            <div class="no-image">
                    ...
                    <div class="item-body">
                        ...
                        <div class="card-actions">
                            ...
                            <a href="/lost-items/<?php echo e($item->id); ?>" class="view-btn">
                                View Details
                            </a>

                            <?php if($isAdmin): ?>
                                <form method="POST" action="/lost-items/<?php echo e($item->id); ?>/delete" class="delete-form">
                                    <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
            ...
            <div class="empty-state">
                No lost item has been reported yet.
            </div>
