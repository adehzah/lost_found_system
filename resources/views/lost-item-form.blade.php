    ...
    <style>
        *{
        ...
        body{
            ...
            background:
                radial-gradient(circle at top left, #e8f5ee 0%, transparent 35%),
...
<div class="page-wrapper">
    ...
    <div class="info-card">
        <span class="badge">Missing Item Report</span>

        <h1>Report a lost item on campus.</h1>

        <p>
            Submit the details of your missing item so it can be recorded in the university lost and found system.
            This helps students and staff identify and return items faster.
        </p>
        ...
        <div class="steps">
            ...
            <div class="step">
                ...
                <div>
                    <h4>Add location and date</h4>
                    <span>Tell us where and when the item got missing.</span>
                </div>
            </div>
            ...
            <div class="step">
                ...
                <div>
                    <h4>Submit your contact</h4>
                    <span>This helps the finder or admin reach you quickly.</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <form method="POST" action="/report-lost-item" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="item_name" placeholder="e.g. iPhone 13, Backpack, ID Card" required>
                </div>

                <div class="form-group">
                    <label>Category</label>
                    <input type="text" name="category" placeholder="e.g. Phone, Bag, Document" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="location_lost" placeholder="e.g. Library, Lecture hall, Hostel" required>
                </div>

                <div class="form-group">
                    <label>Date Lost</label>
                    <div class="date-field">
                        <input type="text" name="date_lost" class="date-input" placeholder="dd/mm/yyyy" inputmode="numeric" maxlength="10" pattern="\d{2}/\d{2}/\d{4}" required>
            ...
            <div class="actions">
                <a href="/lost-items" class="back-btn">View Reported Lost Items</a>
